...
base_path <- "/ix/djishnu/Akanksha/datasets/ERCC1_KO_mice/metacell/slide_outs/optimize_slide/female_0.2_spec/0.01_0.5_out/SLIDE_CV_replicate_data"  # Replace with the path to your directories
...
pdf("/ix/djishnu/Akanksha/datasets/ERCC1_KO_mice/metacell/slide_outs/optimize_slide/female_0.2_spec/0.01_0.5_out/SLIDE_CV_replicate_data/SLIDECV_Boxplot.pdf", height = 5, width = 5)
...
# Save to PDF
ggsave("/ix/djishnu/Akanksha/datasets/ERCC1_KO_mice/metacell/slide_outs/optimize_slide/female_0.2_spec/0.01_0.5_out/SLIDE_CV_replicate_data/SLIDECV_Boxplot.pdf", 
